...
#define AD7799_CS_DESELECT		ADC_TENSO_CS_DESELECT	//ADC_EXT_CS4_DESELECT
#define AD7799_CS_SELECT		ADC_TENSO_CS_SELECT	//ADC_EXT_CS4_SELECT
#define IS_AD7799_CS_SELECT		IS_TENSO_CS_SELECT	//IS_ADC_EXT_CS4_SELECT
